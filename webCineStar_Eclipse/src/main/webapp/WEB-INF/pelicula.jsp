		...
		<br/><h1>Cartelera</h1><br/>
				<div class="contenido-pelicula">
					<div class="datos-pelicula">
						...
						<div class="tabla">
							<div class="fila">
								<div class="celda-titulo">Titulo Original :</div>
							...
							<div class="fila">
								<div class="celda-titulo">Genero :</div>
				...
				<div class="pelicula-video">
					<embed src="http://www.youtube.com/v/<%= pelicula.getLink() %>" type="application/x-shockwave-flash" ="always" allowfullscreen="true" width="580" height="400">
				</div>
	</body>
</html>